export const GoldIcon = () => (
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      <polyline
        id="secondary"
        points="10 10 11.33 11.5 14 8.5"
        style={{
          fill: 'none',
          stroke: '#ffffff',
          strokeLinecap: 'round',
      ...
      <polyline
        id="primary"
        points="5.79 13.57 3 17.56 6.03 18.46 7.91 21 10.73 16.98"
        style={{
          fill: 'none',
          stroke: '#ffffff',
          strokeLinecap: 'round',
      ...
      <polyline
        id="primary-2"
        data-name="primary"
        points="18.21 13.57 21 17.56 17.97 18.46 16.09 21 13.27 16.98"
        style={{
          fill: 'none',
          stroke: '#ffffff',
          strokeLinecap: 'round',
